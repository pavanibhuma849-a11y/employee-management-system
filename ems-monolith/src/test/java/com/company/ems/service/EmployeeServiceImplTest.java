...
public class EmployeeServiceImplTest {
    ...
    public void testGetEmployeesInTreeSet_NaturalOrderingBySalary() {
        ...
        java.util.TreeSet<Employee> result = employeeService.getEmployeesInTreeSet();
        ...
        java.util.Iterator<Employee> iterator = result.iterator();
    ...
    public void testGetEmployeeMapById_O1Lookup() {
        ...
        java.util.Map<Long, Employee> result = employeeService.getEmployeeMapById();
