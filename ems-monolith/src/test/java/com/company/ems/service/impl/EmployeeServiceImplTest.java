...
public class EmployeeServiceImplTest {
    ...
    @Test
    public void testCreateEmployee_WithProjects_AssignsProjectNames() {
        ...
        assertNotNull(result);
        assertNotNull(result.getProjectNames());
        assertEquals(Set.of("Alpha", "Beta"), result.getProjectNames());
        assertNotNull(employeeCaptor.getValue().getProjects());
        assertEquals(2, employeeCaptor.getValue().getProjects().size());
    ...
    @Test
    public void testUpdateEmployee_WithProjects_AssignsProjectNames() {
        Project project1 = new Project();
        project1.setId(10L);
        project1.setName("Alpha");
        Project project2 = new Project();
        ...
        updateDTO.setSalary(60000.0);
        updateDTO.setJoiningDate(LocalDate.of(2022, 1, 15));
        updateDTO.setProjectIds(Set.of(10L, 11L));
        ...
        updatedEmployee.setSalary(60000.0);
        updatedEmployee.setJoiningDate(LocalDate.of(2022, 1, 15));
        updatedEmployee.setProjects(Set.of(project1, project2));
    ...
    @Test
    public void testGetEmployeeById_UnexpectedException1() {
    ...
    @Test
    public void testGetAllEmployeesSortedBySalary_SortsNaturallyBySalary() {
        Employee low = new Employee();
        low.setId(1L);
        low.setName("Low");
        low.setSalary(1000.0);
        low.setJoiningDate(LocalDate.of(2020, 1, 1));

        Employee mid = new Employee();
        mid.setId(2L);
        mid.setName("Mid");
        mid.setSalary(2000.0);
        mid.setJoiningDate(LocalDate.of(2020, 1, 1));

        Employee high = new Employee();
        high.setId(3L);
        high.setName("High");
        high.setSalary(3000.0);
        high.setJoiningDate(LocalDate.of(2020, 1, 1));

        when(employeeRepository.findAll()).thenReturn(Arrays.asList(high, low, mid));
        ...
        assertEquals("High", result.get(2).getName());
        verify(employeeRepository, times(1)).findAll();
    }

    @Test
    public void testGetAllEmployeesSortedBySalary_RepositoryException() {
        when(employeeRepository.findAll()).thenThrow(new RuntimeException("DB down"));
    ...
    @Test
    public void testMapToResponseDTO_WithNullProjectElement_Throws() {
        Employee broken = new Employee();
        broken.setId(1L);
        broken.setName("Broken");
        broken.setRole("Role");
        broken.setSalary(1.0);
        broken.setJoiningDate(LocalDate.of(2020, 1, 1));

        HashSet<Project> projects = new HashSet<>();
        projects.add(null);
        broken.setProjects(projects);

        when(employeeRepository.findById(1L)).thenReturn(Optional.of(broken));
